# 🏦 BankQuery AI — Horizon Bank CSR Query Summarizer
...
> 🎬 **[Click here to watch the full demo video](#)** ← *(replace with your YouTube/Drive link)*

[![Demo Thumbnail](https://img.shields.io/badge/▶_Watch_Demo-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](#)
...
```bash
git clone https://github.com/YOUR_USERNAME/bankquery-ai.git
cd bankquery-ai
```
...
bankquery-ai/
│
├── main.py               # FastAPI app — core API routes & PDF generation
├── rag.py                # RAG module — TF-IDF vector retrieval
├── translator.py         # Language detection & multilingual translation
├── bank_knowledge.json   # Horizon Bank knowledge base (rates, policies, fees)
├── index.html            # Frontend UI
│
├── NotoSans-Regular.ttf  # Unicode font for PDF
├── NotoSans-Bold.ttf
├── NotoSans-Italic.ttf
│
├── pdfs/                 # Auto-generated PDF reports (git-ignored)
├── .env                  # API credentials (git-ignored ⚠️)
